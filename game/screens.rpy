...
screen navigation():
    ...
    vbox:
        ...
        if renpy.config.developer and not main_menu:

            textbutton _("Debug mini-jeux") action ShowMenu("debug_minigames")
...
screen grille_horloge:
    if not clef_horloge:
        imagebutton:
            xpos 0.37
            ypos 0.551
            idle "images/open_image.png"  # Image de l'état normal du bouton
            hover "images/open_image_hover.png"  # Image de l'état survolé du bouton     
...
screen inventory_icon():
    imagebutton:
        ...
        hover "images/backpack-hover.png"
...
screen plan_icon():
    imagebutton:
        idle "images/minimap.png"
        hover "images/minimap-hover.png"
...
screen plan_screen():
    ...
    frame:
        ...
        background None
        imagemap:
            ground "/images/plan_cathedrale.png"
            
            if location_cloitre_active:
                hotspot (279, 90, 271, 245) action [Hide ("plan_screen"), Jump("dial_eveque2")] #cloitre
...
screen coffre_ouvert:
    ...
    add "/images/coffre-taille-normale-ouvert.png" xalign 0.5 yalign 0.5 # affiche l'image du coffre ouvert
...
#### bouton clef horloge pour test :
screen toggle_button():
    # Utilisez un bouton textuel pour appeler la fonction toggle_key
    textbutton "Toggle clef_horloge" action Function(toggle_key)
    text "clef_horloge est : [clef_horloge]" xpos 0.5 ypos 0.5
...
screen rotating_image():
    ...
    add "/images/rosace.png" xpos 0.5 ypos 0.5 anchor (0.5, 0.5)
